...
N -0 0 100 0 {lab=gd}
N 700 -400 780 -400 {lab=vp}
N 700 -500 780 -500 {lab=vp}
N 700 -470 700 -430 {lab=vp}
N 880 -400 960 -400 {lab=vp}
N 880 -500 960 -500 {lab=vp}
N 880 -470 880 -430 {lab=vp}
N 620 -400 660 -400 {lab=pbias}
N 620 -500 660 -500 {lab=pbias}
N 620 -440 620 -400 {lab=pbias}
N 800 -400 840 -400 {lab=pbias}
N 800 -500 840 -500 {lab=pbias}
N 800 -450 800 -400 {lab=pbias}
N 400 -440 470 -440 {lab=pbias}
N 400 -450 400 -440 {lab=pbias}
N 470 -450 470 -440 {lab=pbias}
N 470 -450 490 -450 {lab=pbias}
N 490 -450 490 -440 {lab=pbias}
N 490 -440 620 -440 {lab=pbias}
N 620 -450 620 -440 {lab=pbias}
N 620 -450 690 -450 {lab=pbias}
N 620 -500 620 -450 {lab=pbias}
N 690 -460 690 -450 {lab=pbias}
N 690 -460 710 -460 {lab=pbias}
N 710 -460 710 -450 {lab=pbias}
N 710 -450 800 -450 {lab=pbias}
N 800 -500 800 -450 {lab=pbias}
N 480 -560 700 -560 {lab=vp}
N 700 -560 700 -530 {lab=vp}
N 700 -560 880 -560 {lab=vp}
N 880 -560 880 -530 {lab=vp}
N 700 -370 700 -340 {lab=vp}
N 700 -340 880 -340 {lab=vp}
N 880 -370 880 -340 {lab=vp}
...
C {lab_wire.sym} 780 -400 0 0 {name=p4 sig_type=std_logic lab=vp}
C {sg13cmos5l_pr/sg13_hv_pmos.sym} 680 -400 0 0 {name=M11
l=2u
w=0.6u
ng=1
m=1
...
C {lab_wire.sym} 780 -500 0 0 {name=p5 sig_type=std_logic lab=vp}
C {sg13cmos5l_pr/sg13_hv_pmos.sym} 680 -500 0 0 {name=M12
l=2u
w=0.6u
ng=1
m=1
...
C {lab_wire.sym} 960 -400 0 0 {name=p6 sig_type=std_logic lab=vp}
C {sg13cmos5l_pr/sg13_hv_pmos.sym} 860 -400 0 0 {name=M13
l=2u
w=0.6u
ng=1
m=1
...
C {lab_wire.sym} 960 -500 0 0 {name=p7 sig_type=std_logic lab=vp}
C {sg13cmos5l_pr/sg13_hv_pmos.sym} 860 -500 0 0 {name=M14
l=2u
w=0.6u
ng=1
m=1
...
C {lab_wire.sym} 790 -340 0 0 {name=p8 sig_type=std_logic lab=vp}
C {lab_wire.sym} 880 -440 0 0 {name=p9 sig_type=std_logic lab=vp}
C {lab_wire.sym} 700 -440 0 1 {name=p10 sig_type=std_logic lab=vp}
