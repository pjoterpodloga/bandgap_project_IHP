...
N 800 -310 800 -200 {lab=#net2}
N 920 -140 920 -100 {lab=#net3}
N 800 -140 800 -100 {lab=#net3}
...
N 860 -100 860 -80 {lab=#net3}
N 800 -100 860 -100 {lab=#net3}
N 860 -20 860 0 {lab=gd}
N 1180 -280 1250 -280 {lab=out}
N 520 -380 520 -330 {lab=vp}
N 520 -110 520 0 {lab=gd}
N 650 -260 740 -260 {lab=#net4}
N 740 -290 740 -260 {lab=#net4}
N 740 -370 740 -350 {lab=bias}
N 650 -280 680 -280 {lab=#net5}
N 650 -240 680 -240 {lab=#net6}
N 1080 -470 1080 -440 {lab=vp}
N 910 -310 1000 -310 {lab=inp}
N 800 -310 850 -310 {lab=#net2}
...
C {vsource.sym} 320 -210 0 0 {name=VIN value="DC=xvid AC=1" ac=1 savecurrent=false}
...
C {vsource.sym} 880 -310 1 0 {name=VIN1 value="DC='vioff' AC=0" ac=1 savecurrent=false}
