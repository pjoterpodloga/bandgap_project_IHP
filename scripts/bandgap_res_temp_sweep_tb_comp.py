...
bjt_legend_elements = [
    plt.Line2D([0], [0], color='g', linestyle='-',  label="pnp_typ"),
    plt.Line2D([0], [0], color='b', linestyle='-',  label="pnp_bcs"),
    plt.Line2D([0], [0], color='r', linestyle='-',  label="pnp_wcs"),
]
vp_legend_elements = [
    plt.Line2D([0], [0], color='g', linestyle='-',  label="3.3V"),
    plt.Line2D([0], [0], color='b', linestyle='-',  label="2.97V"),
    plt.Line2D([0], [0], color='r', linestyle='-',  label="3.63V"),
]

plt.legend(handles=bjt_legend_elements, 
           title="Wariant technologiczny",
           loc="upper left", 
